...
#ifndef ONEPLUS_BUDS_MENU_SWIFT_H
#define ONEPLUS_BUDS_MENU_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OnePlus_Buds_Menu",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17OnePlus_Buds_Menu21BudsCommandController")
@interface BudsCommandController : NSObject
...
@interface BudsCommandController (SWIFT_EXTENSION(OnePlus_Buds_Menu)) <CBPeripheralDelegate>
...
@class NSString;
@class NSNumber;
@interface BudsCommandController (SWIFT_EXTENSION(OnePlus_Buds_Menu)) <CBCentralManagerDelegate>
